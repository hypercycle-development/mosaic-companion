...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigate, customGreeting, onOpenCommandPalette }) => {
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 max-w-5xl w-full px-4">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="text-2xl md:text-4xl font-light tracking-wide flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3 text-gray-400 font-sans">
            ...
            <div className="h-12 flex items-center justify-center min-w-[220px] bg-gray-900/50 rounded-lg border border-gray-800 backdrop-blur-sm px-4 shadow-inner">
               <span key={currentSWord.word} className={`font-bold tracking-widest ${currentSWord.color} animate-in slide-in-from-bottom-2 fade-in duration-300 drop-shadow-md`}>
                 {currentSWord.word}
               </span>
            </div>
        ...
        <div className="mt-12 flex items-center gap-4 justify-center">
            ...
            >
                <div className="flex items-center gap-3">
                    <div className="p-1.5 bg-indigo-500 rounded-full group-hover:scale-110 transition-transform shadow-[0_0_10px_rgba(99,102,241,0.5)]">
                        <Play size={16} fill="white" className="text-white" />
                    </div>
                    <span className="text-sm font-medium tracking-widest text-indigo-300 group-hover:text-white transition-colors">WATCH DEMO</span>
                </div>
            </button>
            ...
            {onOpenCommandPalette && (
                ...
                >
                    <div className="flex items-center gap-2">
                        <Command size={16} className="text-gray-400 group-hover:text-indigo-400" />
                        <span className="text-xs font-mono text-gray-500 group-hover:text-gray-300">⌘K</span>
                    </div>
                </button>
            )}
        </div>
        ...
        <div className="mt-16 flex gap-8 opacity-60">
            <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-[10px] uppercase tracking-widest text-gray-500">System Online</span>
            </div>
            <div className="flex flex-col items-center gap-1">
                <div className="w-2 h-2 rounded-full bg-indigo-500 shadow-[0_0_10px_rgba(99,102,241,0.8)]" />
                <span className="text-[10px] uppercase tracking-widest text-gray-500">Neural Link Active</span>
            </div>
            <div className="flex flex-col items-center gap-1">
                <div className="w-2 h-2 rounded-full bg-cyan-500 shadow-[0_0_10px_rgba(6,182,212,0.8)]" />
                <span className="text-[10px] uppercase tracking-widest text-gray-500">Privacy Shielded</span>
            </div>
        </div>
