...
export interface CoreTabDef {
   ...
   * "Sidebar Tabs" section and become hide/show-able. Addon tabs are always
   * `toggleable: true`.
   */
  toggleable: boolean;
...
/**
 * Tab-id prefix for addon-contributed tabs: `addon:<addonId>`.
 ...
 * tabs are always toggleable (a fixed decision: addon tabs are appended
